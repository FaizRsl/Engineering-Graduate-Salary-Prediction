...
> - ####  Our predictor variables have very low correlation to our response variable(Salary) 
     1. From the plotted graph, we deduced that 10th percentage and 12th percentage have a linear relationship hence we decided to drop 10percentage, as it is redundant.
     2. Where our highest correlation to Salary is Quant of 0.24.
     3.  Hence, we can conclude that the R^2 of our model will be low
